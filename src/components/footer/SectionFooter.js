...
export default function SectionFooter() {
  return (
    <section className="  ">
      <div className="bg-[#23272a] flex flex-col py-16 px-6 sm:px-20 md:px-20">
        <div className="flex flex-col md:flex-row justify-center md:gap-10">
          ...
          <div className="flex flex-wrap justify-start md:justify-between sm:gap-7">
            {DataFooter.map((item) => (
              // Utilisation de la méthode map() pour afficher les éléments venant de la card dataFooter qui contient un tableau avec des propriété title et une propriété liens.
              <div
